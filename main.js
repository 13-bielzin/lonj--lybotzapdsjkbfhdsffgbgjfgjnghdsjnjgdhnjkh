...
require('./index.js')
nocache('./index.js', module => console.log(`${module} atualizado✓`))
...
masuk =`ola: *@${num.split('@')[0]} .*\n𝐀𝐠𝐨𝐫𝐚 𝐝𝐞𝐬𝐜𝐮𝐛𝐫𝐚 𝐮𝐦 𝐩𝐨𝐮𝐜𝐨 𝐬𝐨𝐛𝐫𝐞 𝐦𝐢𝐦 UwU !!\n𝐍𝐨𝐦𝐞: Meguminaru\n𝐏𝐫𝐞𝐟𝐢𝐱: ;\n𝐈𝐝𝐚𝐝𝐞: pq vc quer saber isso bro?\n𝐒𝐭𝐚𝐭𝐮𝐬: By Lonly`
Lexxy.sendMessage(mdata.id, masuk, MessageType.text, { quoted: fkontakk, thumbnail: fs.readFileSync('./gambar/fake.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `bem vindo a ${mdata.subject}`,body:"",mediaType:"2",thumbnail:buff,mediaUrl:`instagram.com/lonly__kkkj`}}})
